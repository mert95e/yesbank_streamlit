...
if selected_tab == "Ana Sayfa":
    ...
    st.markdown("Yes Bank, Hindistan'da finans alanında tanınmış bir bankadır. 2018'den beri Rana Kapoor'un karıştığı dolandırıcılık davası nedeniyle haberlerde yer alıyor. "
